...
private:
	...
	HWND                    m_hWndCpy;         // handle to the video window
    IDirect3DDevice9*       m_pDevice;      // Direct3DDevice
 
	D3DFORMAT m_CreateFmt ;
	...
	DWORD					m_dwNextRender;	// next time we'll render the scene
	...
	CCritSec				m_BackBufferLock;//×¥Í¼Ëø
	LONG m_lTop;
	LONG m_lBottom;
public:
