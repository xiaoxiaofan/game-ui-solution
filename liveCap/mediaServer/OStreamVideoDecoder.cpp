...
AVFrame* OStreamVideoDecoder::create_avframe( int pixel_format, int frame_width, int frame_height )
{
	...
	pic_size = avpicture_get_size( (PixelFormat)pixel_format, frame_width, frame_height );
	...
	avpicture_fill((AVPicture *)frame, picture_buf, (PixelFormat)pixel_format, frame_width, frame_height );
	return frame;
}
